...
#Import datasets
X_train = pd.read_csv('../Database/Final_datasets/X_train.csv') 
X_test = pd.read_csv('../Database/Final_datasets/X_test.csv')
Y_train_DCR = pd.read_csv('../Database/Final_datasets/Y_train_DCR.csv')
Y_test_DCR = pd.read_csv('../Database/Final_datasets/Y_test_DCR.csv')
...
#deifining model for GridSearch
...
plt.legend(loc='best')
plt.savefig('../CatBoost/Final_results/ROC_DCR_B',dpi=300)
plt.show()
...
plt.savefig('../CatBoost/Final_results/confusionmatrix_DCR.png',dpi=300)
...
plt.savefig('../CatBoost/Final_results/DCR_SHAP_B.png', bbox_inches='tight')
...
with open('../CatBoost/Final_results/results_DCR.txt', 'w') as f2:
